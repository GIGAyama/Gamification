...
校内のフィルタリングで許可が必要になるのは三つです。子どもに配るページと学習アプリが置いてある gigayama.github.io、まなびクエスト本体が動く script.google.com、そしてその中身が表示される script.googleusercontent.com です。どれも Google と GitHub の標準的な場所なので、すでに許可されている学校も多いと思います。
