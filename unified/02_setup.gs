 ...
 * =====================================================================
 * setupDatabase() を 1 回実行するだけで、統合版に必要な全シートを
...
const DEFAULT_CONFIG = [
  ...
  ['100マス計算タイム除数', 0.05, '獲得経験値 = 点数 − floor(タイム ÷ 除数)'],
...
const DEFAULT_MISSIONS = [
  ...
  ['M002', 'デイリー', '100マスけいさんに1回ちょうせんしよう', 'RECORD_CALC', 1, '経験値', 30, 'TRUE'],
